...
- Imagery is archival photographs, treated by `tools/treat-images.py`. The one exception is the "About LEAP" band on the home page, which shows one of LEAP's own photographs (`_data/gallery.yml`), black and white, drawn at random per visit. No other event or launch photographs in the design itself. News posts may carry their own photos.
