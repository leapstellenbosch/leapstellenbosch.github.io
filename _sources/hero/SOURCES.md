# Sources of the home page letters

The originals are NOT in this repository. They sit on Johan Fourie's Dropbox, and
`tools/treat-images.py` (the `HERO` list) reads them from there, crops them, tints
them in the letter's colour and writes a 900px WebP to `assets/img/hero/`.
Compiled 2026-09-21. Paths are relative to `Dropbox\3 Data\` unless they start with `5 LEAP\`.

| Image | Source file | Note |
|---|---|---|
| l-free-state-map | `5 LEAP\Photos\Website photos\IMG_4202.JPG` | Photograph of an engraved map |
| l-africa-de-wit | `Maps\JN12021 - KHC AF - 1660 DE WIT.tif` | |
| l-africa-1578 | `Archive photos\Elliot Collection\E4430 ...tif` | Western Cape Archives, Elliott Collection |
| l-cape-town-1897 | `Maps\CapeTown1897.jpg` | From Juta's Cape Town directory |
| l-cadastral-albert | `Robert Ross maps\Cape Colony Cadastral Maps c.1890 M3 Series\1588\... 063.jpg` | |
| e-barberton | `5 LEAP\Photos\Website photos\Barberton.JPG` | |
| e-rogge-bay | `Archive photos\2020\AG983 ...tif` | Western Cape Archives, AG Collection |
| e-wine-farm | `Archive photos\2020\AG1044 ...tif` | Western Cape Archives, AG Collection |
...
| a-zar-certificate | `5 LEAP\Photos\Limited Liability\IMG_3344.JPG` | |
| a-register | `5 LEAP\Photos\Limited Liability\IMG_6647.JPG` | |
